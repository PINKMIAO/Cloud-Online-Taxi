...
//        parseBody(request);
        ...
        if (StringUtils.isNotBlank(token)){
            ...
            if(null != verify) {
                ...
                BoundValueOperations<String, String> stringStringBoundValueOperations = redisTemplate.boundValueOps(RedisKeyPrefixConstant.PASSENGER_LOGIN_TOKEN_APP_KEY_PRE + payload);
